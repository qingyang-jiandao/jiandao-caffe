...
void SpatialTransformerPTLTLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void SpatialTransformerPTLTLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
Dtype SpatialTransformerPTLTLayer<Dtype>::transform_forward_cpu(const Dtype* pic, Dtype px, Dtype py) {
...
template <typename Dtype>
void SpatialTransformerPTLTLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SpatialTransformerPTLTLayer<Dtype>::transform_backward_cpu(Dtype dV, const Dtype* U, const Dtype px,
...
template <typename Dtype>
void SpatialTransformerPTLTLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SpatialTransformerPTLTLayer);
#endif

INSTANTIATE_CLASS(SpatialTransformerPTLTLayer);
REGISTER_LAYER_CLASS(SpatialTransformerPTLT);
