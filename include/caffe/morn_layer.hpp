...
class MornLayer : public Layer<Dtype> {

public:
	explicit MornLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {
...
private:
	...
	int N, C, H, W;
	int offset_N, offset_C, offset_H, offset_W;

	bool global_debug;
	bool to_compute_dU_;

	Blob<Dtype> offsets_trans;	// used for back propagation part in GPU implementation
