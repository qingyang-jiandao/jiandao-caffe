#ifndef ST_PT_OP_LAYER_HPP_
#define ST_PT_OP_LAYER_HPP_
...
class SpatialTransformerPTOPLayer : public Layer<Dtype> {

public:
	explicit SpatialTransformerPTOPLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {
