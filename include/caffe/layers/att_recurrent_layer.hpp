#ifndef CAFFE_ATT_RECURRENT_LAYER_HPP_
#define CAFFE_ATT_RECURRENT_LAYER_HPP_
...
//template <typename Dtype> class AttRecurrentLayer;
...
class AttRecurrentLayer : public Layer<Dtype> {
 public:
  explicit AttRecurrentLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "AttRecurrent"; }
 ...
 protected:
   ...
   *      Refer to documentation for particular AttRecurrentLayer implementations
