#ifndef ST_PT_LAYER_HPP_
#define ST_PT_LAYER_HPP_
...
class SpatialTransformerPTLayer : public Layer<Dtype> {

public:
	explicit SpatialTransformerPTLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {
