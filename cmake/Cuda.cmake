...
set(Caffe_known_gpu_archs "50 60 61 75")
...
function(caffe_detect_installed_gpus out_variable)
  if(NOT CUDA_gpu_detect_output)
    ...
    execute_process(COMMAND "${CUDA_NVCC_EXECUTABLE}" "--run" "${__cufile}" "-w"
    ...
    if(__nvcc_res EQUAL 0)
      ...
      # breaks in the cache
	  #string(REGEX MATCH "([^a-zA-Z][1-9]\\.[0-9])" __nvcc_out "${__nvcc_out}")
