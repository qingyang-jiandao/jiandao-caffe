...
if NOT EXIST build_caffe_win64_gpu_archs mkdir build_caffe_win64_gpu_archs
pushd build_caffe_win64_gpu_archs

:: Setup the environement for VS x64
::set batch_file=!VS%MSVC_VERSION%0COMNTOOLS!..\..\VC\vcvarsall.bat
::set batch_file=C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat
set batch_file=C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\VC\Auxiliary\Build\vcvars64.bat
call "%batch_file%" amd64

echo huitang_INFO: %~dp0
...
cmake -G"!CMAKE_GENERATOR!" ^
	  ...
	  -DCUDNN_ROOT=G:/deeplab-jiandao/tools/cuda ^
      "%~dp0"
